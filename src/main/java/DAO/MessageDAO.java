...
public class MessageDAO {
    ...
    /**
     * TODO: retrieve a Message from the Message table, identified by its isbn.
     * You only need to change the sql String and leverage PreparedStatement's setString and setInt methods.
     * @return a Message identified by isbn.
     */
    ...
    /**
     * TODO: retrieve all Messages from the Message table with copies_available over zero.
     * You only need to change the sql String with a query that utilizes a WHERE clause.
     * @returnall Messages with Message count > 0.
     */
